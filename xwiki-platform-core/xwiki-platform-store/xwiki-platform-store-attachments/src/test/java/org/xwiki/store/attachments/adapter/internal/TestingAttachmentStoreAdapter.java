...
/**
 * Attachment store adapter for testing AbstractAttachmentStoreAdapter.
 *
 * @version $Id$
 * @since TODO
 */
public class TestingAttachmentStoreAdapter extends AbstractAttachmentStoreAdapter
{
    private final AttachmentContentStore contentStore;

    private final AttachmentStore metaStore;

    public TestingAttachmentStoreAdapter(final AttachmentContentStore contentStore,
                                         final AttachmentStore metaStore,
    ...
    @Override
    protected AttachmentStore getMetaStore()
    {
